...
class Validator:
    ...
    def allow_schemes(self, *schemes: str) -> compat.Self:
        ...
        :rtype:
            Validator
        """
        self.allowed_schemes.update(schemes)
        return self

    def allow_hosts(self, *hosts: str) -> compat.Self:
    ...
    def allow_ports(self, *ports: str) -> compat.Self:
    ...
    def allow_use_of_password(self) -> compat.Self:
    ...
    def forbid_use_of_password(self) -> compat.Self:
    ...
    def check_validity_of(self, *components: str) -> compat.Self:
    ...
    def require_presence_of(self, *components: str) -> compat.Self:
...
def subauthority_component_is_valid(
    ...
    try:
        port = int(subauthority_dict["port"])  # pyright: ignore [reportArgumentType] # Guarded with except TypeError.
    except TypeError:
